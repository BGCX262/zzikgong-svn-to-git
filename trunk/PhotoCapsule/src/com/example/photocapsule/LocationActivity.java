...
public class LocationActivity extends NMapActivity {
	...
	private static final String API_KEY = "6d17c34da43c20e7b5b4379b3d4ed762";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// create map view
				...
				poiData.addPOIitem(ReceiveActivity.lng, ReceiveActivity.lat, library_name, markerId, 0);
				...
				NMAP_LOCATION_DEFAULT = new NGeoPoint(ReceiveActivity.lng, ReceiveActivity.lat);
